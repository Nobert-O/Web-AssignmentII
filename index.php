...
<html lang="en">
  <head>
    ...
    <link rel="title icon" href="images/ALU.png">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              <a href="#" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-4 bottom-border">Admin Manager</a>
              <div class="bottom-border pb-3">
                <img src="images/ALU.png" width="50" class=" mr-3">
                <a href="#" class="text-white">Okoye-Nobert</a>
              </div>
              <ul class="navbar-nav flex-column mt-4">
                ...
                <li class="nav-item"><a href="#" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-calendar-alt text-light fa-lg mr-3"></i>Events</a></li>
                <li class="nav-item"><a href="#" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-chess text-light fa-lg mr-3"></i>Clubs</a></li>
                ...
                <li class="nav-item"><a href="#" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-chalkboard-teacher text-light fa-lg mr-3"></i>Meetings</a></li>
            ...
            <div class="row pt-md-5 mt-md-3 mb-5">
              ...
              <div class="col-xl-3 col-sm-6 p-2">
                <div class="card card-common">
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      <i class="fas fa-chess fa-3x text-success"></i>
                      <div class="text-right text-secondary">
                        <h5>Add Clubs</h5>
                        <h4><i class="fas fa-plus"></i></h4>
                      </div>
